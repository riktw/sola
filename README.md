...
samllConfig: This disables setting the samplerate lower then the clock and setting channel groups. Those are generally not needed for internal LA use and save some space.
